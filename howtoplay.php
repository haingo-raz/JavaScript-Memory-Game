...
<div class="rules-container">
    ...
    <ul id="tutorials">
        ...
        <li>Go on the <a href="game.php">game</a> page.</li>
        ...
        <li>You can logout in the <a href="game.php">game</a> page by clicking on the logout link in the top right corner</li>
    </ul>
</div>
